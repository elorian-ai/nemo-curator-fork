...
| --- | --- |
| `ExactDeduplicationWorkflow` | `total_time`, `num_duplicates`, `identification_time`, `id_generator_path` |
| `FuzzyDeduplicationWorkflow` | `total_time`, `num_duplicates`, `minhash_time`, `lsh_time`, `id_generator_path` |
...
| `TextSemanticDeduplicationWorkflow` | `total_time`, `num_duplicates`, `num_duplicates_removed`, `embedding_time`, `identification_time`, `removal_time`, `final_output_path` |
...
- [WorkflowRunResult / WorkflowBase](https://github.com/NVIDIA-NeMo/Curator/blob/main/nemo_curator/pipeline/workflow.py)
